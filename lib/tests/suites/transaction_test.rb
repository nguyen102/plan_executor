module Crucible
  module Tests
    class TransactionAndBatchTest < BaseSuite
      ...
      def create_patient_observation_condition_0
      ...
      test 'XFER0','Create a Patient Record as Transaction' do
        ...
        reply = create_patient_observation_condition_0
      ...
      test 'XFER7','Delete an Ordered Patient Record as Transaction' do
        ...
        # We have to manually recreate patient 0 since in test XFER6 we deleted patient 0
        create_patient_observation_condition_0
